...
description: Introduction to use-case ADRs that build on network-ADRs to solve specific business problems and enable data exchange for value-creating processes.
---
...
The Factory-X project has so far focused on publishing [**network-ADRs**](../../docs/hercules_network_adr) that specify
...
Now, this solid foundation is put to use as the foundation for [**use-case ADRs**](../../docs/hercules_use_case_adr).
