...
Feature: ADR 012 – MQTT over DSP
  ...
  Scenario: Consumer connects to MQTT broker using username/password authentication (mqtt-usrpw)
    Given a Consumer has received a DataAddress with credentials via "https://w3id.org/dspace/2025/1/mqtt-pull/user" and "https://w3id.org/dspace/2025/1/mqtt-pull/password"
